...
//!
//! Colour and cursor control are emitted only when stdout is an interactive
//! terminal and `NO_COLOR` is unset, so piped output, CI logs and Kaggle
//! notebook logs stay plain parseable text. Every machine-readable
